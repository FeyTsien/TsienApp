package com.hdnz.inanming.ui.activity.license.register;
 ...
 * FileName:    RegistrationFormActivity.java
 * Author:      肖昕
 * Email:       xiaox@huadiannanzi.com
 * Date:        2018-11-15 15:26
 * Description: 登记表照activity
 * Version:     V1.0.0
 * History:     历史信息
 */
public class RegistrationFormActivity extends MVPActivity<MVPContract.View, MVPPresenter>
    ...
    protected void initView() {
        setToolBar(mToolbar, tvTitle, getResources().getString(R.string.upload_register_license_photo));
        tvRightMenu.setVisibility(View.VISIBLE);
        tvRightMenu.setText(R.string.save);
        tvSinglePhotoDesc.setText(getResources().getString(R.string.upload_register_license_photo));
