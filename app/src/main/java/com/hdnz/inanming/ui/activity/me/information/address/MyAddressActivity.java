 ...
 * History:     历史信息
 */
public class MyAddressActivity extends MVPActivity<MVPContract.View, MVPPresenter> {
    ...
    protected void initView() {
        ...
        if (mAddress == null) {
            ...
            if (!TextUtils.isEmpty(mAddress.getLdName())) {
                tvShowBlock.setText(mAddress.getLdName());
            } else if (!TextUtils.isEmpty(mAddress.getSjhName())) {
                tvShowBlock.setText(mAddress.getSjhName());
            }
...
//        params.setSq(communityId);
    ...
    @OnClick({R.id.tv_right_menu, R.id.rl_building, R.id.rl_house_number})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.rl_building:
                //选择楼栋
                WebViewActivity.goToWebView(this, UrlUtils.H5_HOME_BASE_URL+"addressMap");
