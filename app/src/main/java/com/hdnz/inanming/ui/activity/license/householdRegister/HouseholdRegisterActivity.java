package com.hdnz.inanming.ui.activity.license.householdRegister;
 ...
 * FileName:    HouseholdRegisterActivity.java
 * Author:      肖昕
 * Email:       xiaox@huadiannanzi.com
 * Date:        2018-11-14 14:04
 * Description: 居民户口本activity
 * Version:     V1.0.0
 * History:     历史信息
 */
public class HouseholdRegisterActivity extends MVPActivity<MVPContract.View, MVPPresenter>
    ...
    protected int getLayoutId() {
        return R.layout.activity_household_register;
    }
    ...
    protected void initView() {
        setToolBar(mToolbar, tvTitle, getResources().getString(R.string.upload_household_license_photo));
